...
export const communityPosts: CommunityPost[] = [
  ...
  {
    id: 'bench-lighting-tip',
    category: 'free',
    title: '작업대 조명 밝기 어떻게 맞추고 계세요?',
    excerpt:
      '손목 부담이 적으면서도 색을 정확히 보기 좋은 조명 세팅이 궁금해요. 쓰는 램프가 있으면 알려주세요.',
    author: 'atelier moss',
    date: '03.28',
    views: 68,
    comments: 4,
    content: [
      '최근에 작업 시간을 늘리면서 조명의 중요성을 더 크게 느끼고 있어요. 너무 차갑게 밝으면 금속 색이 딱딱하게 보이고, 반대로 너무 누르면 디테일이 잘 안 보이더라고요.',
      '지금은 책상용 암 램프와 천장 조명을 같이 쓰는데, 세팅이 완전히 만족스럽지는 않습니다. 실제 작업하실 때 기준이 되는 색온도나 밝기 조합이 있으시면 참고하고 싶어요.',
      '확대경 일체형 조명을 쓰는 분들도 많은데, 장단점까지 함께 들을 수 있으면 좋겠습니다.'
    ],
    commentList: [
      {
        author: '구름실버',
        date: '03.28',
        body: '저는 4000K 정도가 가장 무난했어요. 너무 하얗지 않아서 장시간 작업할 때 덜 피로했습니다.'
      }
    ]
  },
  {
    id: 'soldering-burner-sale',
    category: 'market',
    title: '소형 토치 버너 필요하신 분 있을까요?',
    excerpt:
      '예비 장비 정리 중이라 상태 좋은 소형 버너를 양도하려고 합니다. 구성품 포함 여부도 같이 전달드릴게요.',
    author: 'studio ember',
    date: '03.27',
    views: 55,
    comments: 2,
    content: [
      '예비로 보관하던 소형 토치 버너를 정리하려고 합니다. 점화 잘 되고 본체 상태도 양호한 편이라 입문용이나 서브 장비로 쓰기 괜찮아요.',
      '기본 노즐과 연결 부속은 함께 드릴 예정이고, 가스통은 제외입니다. 직거래는 종로 또는 성수 쪽에서 가능합니다.',
      '필요하신 분은 댓글 남겨주시면 사진과 사용감 자세히 보내드릴게요.'
    ],
    commentList: [
      {
        author: '민트링',
        date: '03.27',
        body: '연결 부속 규격이 어떻게 될까요? 기존 장비랑 호환되는지 보고 싶어요.'
      }
    ]
  },
  {
    id: 'casting-service-cost',
    category: 'qa',
    title: '소량 캐스팅 맡기면 보통 단가가 어느 정도인가요?',
    excerpt:
      '반지 샘플 3~5개 정도 소량으로 뽑아보려는데, 업체마다 편차가 큰 것 같아 기준이 궁금합니다.',
    author: 'silver porch',
    date: '03.26',
    views: 84,
    comments: 5,
    content: [
      '이번에 반지 샘플을 소량으로 먼저 확인해보려고 하는데, 캐스팅 단가 감이 잘 안 잡혀서 질문 남깁니다.',
      '수량은 3개에서 5개 정도이고 은으로 진행할 예정이에요. 왁스 상태로 넘길지, 파일까지 어느 정도 정리해서 넘길지에 따라 금액 차이가 큰지도 궁금합니다.',
      '최근 맡겨보신 분들 계시면 대략적인 비용 범위나 추천 업체 분위기만이라도 공유 부탁드려요.'
    ],
    commentList: [
      {
        author: 'atelier noon',
        date: '03.26',
        body: '수량이 적으면 단가가 조금 높긴 했는데, 후가공 포함 여부가 제일 크게 갈렸어요.'
      }
    ]
  },
  {
    id: 'seoul-pop-up-recap',
    category: 'free',
    title: '지난 서울 팝업 참여 후기 공유해요',
    excerpt:
      '부스 동선과 결제 준비에서 배운 점이 많았어요. 처음 참여하시는 분들께 도움이 될까 해서 정리해봅니다.',
    author: 'luna metal',
    date: '03.25',
    views: 102,
    comments: 7,
    content: [
      '지난 주말 서울 팝업에 참여했는데 생각보다 작은 준비 차이가 현장에서 크게 느껴졌어요. 특히 결제 동선과 포장 보관 위치를 미리 정해두는 게 정말 중요했습니다.',
      '처음에는 제품 진열에만 신경 썼는데, 실제로는 고객이 자연스럽게 멈추고 둘러볼 수 있는 흐름을 만드는 쪽이 더 중요하더라고요. 거울 위치와 계산대 방향도 체감상 큰 차이를 만들었습니다.',
      '처음 참여하시는 분들이라면 체크리스트처럼 참고하실 수 있도록 따로 정리해둘까 생각 중이에요. 필요한 항목 있으면 댓글로 남겨주세요.'
    ],
    commentList: [
      {
        author: '온화주얼리',
        date: '03.25',
        body: '결제 동선 이야기가 특히 공감돼요. 체크리스트 올려주시면 저도 꼭 참고하고 싶어요.'
      }
    ]
  }
];
